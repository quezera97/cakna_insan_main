<header class="text-gray-600 body-font bg-white">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
            <a href="{{ route('dashboard') }}" class="mr-5 hover:text-gray-900">{{ __('ui_text.dashboard') }}</a>
            <a href="{{ route('banner.index') }}" class="mr-5 hover:text-gray-900">{{ __('ui_text.main_banner') }}</a>
            <a href="{{ route('post.index') }}" class="mr-5 hover:text-gray-900">{{ __('ui_text.post') }}</a>
            ...
            <div id="dropdownProjectNavbar" class="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-46 dark:bg-light-700">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="{{ route('project.index') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.project_details') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('poster.index') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.project_poster') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('images.index') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.project_images') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('project.banner') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.project_banner') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div id="dropdownDonationNavbar" class="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-light-700">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="{{ route('donation.donation-detail') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.donation_details') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('donation.donation-progress') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.donation_progress') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div id="dropdownNewsNavbar" class="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-light-700">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="{{ route('news.index') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.news_details') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <button id="dropdownSettingsLink" data-dropdown-toggle="dropdownSettingsNavbar" class="flex items-center py-2 mr-5 hover:text-gray-900">
                {{ __('ui_text.settings') }}
                <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg>
            </button>
            <div id="dropdownSettingsNavbar" class="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-light-700">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="{{ route('notification-settings') }}" class="block px-4 py-2 mx-2 hover:bg-gray-300">{{ __('ui_text.notification') }}</a>
                    </li>
                    <li>
