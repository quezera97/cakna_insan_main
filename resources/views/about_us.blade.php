        ...
        <div class="container px-5 py-10 mx-auto flex flex-wrap">
            ...
            <div class="flex flex-wrap w-full">
                <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                    <h1 class="sm:text-2xl text-2xl font-medium title-font text-gray-900 mb-5">{{ __('ui_text.objectives') }}</h1>
            ...
            <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                ...
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">{{ strtoupper(__('ui_text.address')) }}</h2>
                        <a class="leading-relaxed">18 Jalan 9H, Taman Cheras Jaya, Batu 11 Jalan Cheras, Cheras, Selangor</a>
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">{{ strtoupper(__('ui_text.registration_no')) }}</h2>
                        <p class="leading-relaxed">PPM - 029 - 10 - 09102023</p>
                    </div>
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">{{ strtoupper(__('ui_text.email')) }}</h2>
                        <a class="text-indigo-500 leading-relaxed">caknainsanmalaysia@gmail.com</a>
                        <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">{{ strtoupper(__('ui_text.phone_no')) }}</h2>
