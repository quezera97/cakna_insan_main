...
@section('content')
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center flex-wrap ">
                                    <a href="{{ $news->related_url }}" target="_blank" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Read More
            ...
            <div class="mt-10">
                {{ $globalNews->withQueryString()->links('layouts.pagination') }}
            </div>
        </div>
    </section>
@endsection
