                    ...
                    <div class="p-4 md:w-1/3">
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            @if($newsDetail->newsImage->where('type', 'main')->isNotEmpty())
                                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{ asset('storage/'.$newsDetail->newsImage->where('type', 'main')[0]->image_path) }}" alt="blog">
                            @endif
                            <div class="p-6">
                                ...
                                <div class="flex items-center flex-wrap ">
                                    <a href="{{ route('news.cakna_insan_malaysia_details', $newsDetail) }}" class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Read More
