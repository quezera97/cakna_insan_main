        ...
        <div class="bg-gray-100 bg-opacity-75 fixed z-10 inset-0 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen">
                <div class="bg-white w-1/4 h-auto rounded shadow-lg p-8">
                    ...
                    <div class="flex justify-between mt-10">
                        <div></div>
                        <button class="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded mr-2" wire:click="uploadEditBanner">Upload</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-100 bg-opacity-75 fixed z-10 inset-0 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen">
                <div class="bg-white w-1/4 h-auto rounded shadow-lg p-8">
                    ...
                    <div class="flex justify-between mt-10">
                        <div></div>
                        <button class="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded mr-2" wire:click="editBannerDetails">Save</button>
                    </div>
                </div>
            </div>
        </div>
