<div>
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-10 mx-auto">
            <h1 class="text-gray-900 text-2xl title-font font-medium mb-4">{{ __('ui_text.choose_type_of_project') }}</h1>
            <hr><br>
            <div x-data="{ selectedIncoming: @entangle('forIncomingProject'), selectedPast: @entangle('forPastProject') }" class="flex flex-wrap -m-4">
                <button wire:click="selectProject('incoming')" class="lg:w-1/2 p-2" x-bind:class="{ 'border border-indigo-700 border-2 rounded': selectedIncoming === true }">
                    <div class="bg-gray-400 bg-opacity-75 rounded-lg overflow-hidden text-center p-2">
                        <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">{{ __('ui_text.current_projects') }}</h1>
                    </div>
                </button>
                ...
                <button wire:click="selectProject('past')" class="lg:w-1/2 p-2" x-bind:class="{ 'border border-indigo-700 border-2 rounded': selectedPast === true }">
                    <div class="bg-gray-400 bg-opacity-75 rounded-lg overflow-hidden text-center p-2">
                        <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">{{ __('ui_text.past_projects') }}</h1>
                    </div>
                </button>
            </div>
                        ...
                        <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                ...
                                @if ($typeOfProject == $incomingProject)
                                    <div class="p-2 w-full">
                                        <label for="div-date-range" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.date') }}</label>
                                        <div id="div-date-range" class="flex items-center">
                                            ...
                                            <span class="mx-4 text-gray-500">{{ __('ui_text.to') }}</span>
                                            <div class="relative">
                                                <div class="relative max-w-sm">
                        ...
                        <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                @if ($typeOfProject == $pastProject)
                                    <div class="p-2 w-full">
                                        <label for="div-date" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.date') }}</label>
                                ...
                                @endif
                                <div class="p-2 w-full">
                                    <label for="place" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.place') }}</label>
                                ...
                                <div class="p-2 w-1/2">
                                    <label for="div-transportation" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.transportation_provided') }}</label>
                                    <div class="flex" id="div-transportation">
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_yes" class="ms-2 leading-7 text-sm text-gray-600">{{ __('ui_text.yes') }}</label>
                                        </div>
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_no" class="ms-2 leading-7 text-sm text-gray-600">{{ __('ui_text.no') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-2 {{ $typeOfProject == $incomingProject ? 'w-1/2' : 'w-full' }}">
                                    <label for="donation_needed" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.donation_needed') }}</label>
                                ...
                                @if ($typeOfProject == $incomingProject)
                                    ...
                                    <div class="p-2 w-full">
                                        <form class="max-w-[16rem] mx-auto grid grid-cols-2 gap-4">
                                            <div class="my-2">
                                                <label for="start-time" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.start_time') }}</label>
                                                <div class="relative">
                                            ...
                                            <div>
                                                <label for="end-time" class="block mb-2 text-sm font-medium text-gray-900">{{ __('ui_text.end_time') }}</label>
                                                <div class="relative">
