                        ...
                        <div x-show="openIncoming" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                    ...
                                    <textarea id="details-incoming" wire:model.lazy="details" style="height: 123px;" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                                <div class="p-2 w-full">
                        ...
                        <div x-show="openPast" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                    ...
                                    <textarea id="details-past" wire:model.lazy="details" style="height: 123px;" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                            </div>
                        </div>
                        <div x-show="openPast" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                <div class="p-2 w-full">
                                    <label for="div-date-past" class="block mb-2 text-sm font-medium text-gray-900">Date</label>
