                ...
                <section class="text-gray-600 body-font overflow-hidden">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap" x-data="{ openIncoming: @entangle('forIncomingProject') }">
                        <div x-show="openIncoming" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                    <label for="div-date-range-incoming" class="block mb-2 text-sm font-medium text-gray-900">Tarikh <span class="text-red-700">*</span></label>
                                ...
                                <div class="p-2 w-full">
                                    <form class="max-w-[16rem] mx-auto grid grid-cols-2 gap-4">
                                        <div class="my-2">
                                            <label for="start-time-incoming" class="block mb-2 text-sm font-medium text-gray-900">Masa mula:</label>
                                            <div class="relative">
                                        ...
                                        <div>
                                            <label for="end-time-incoming" class="block mb-2 text-sm font-medium text-gray-900">Masa akhir:</label>
                                            <div class="relative">
                                ...
                                <div class="p-2 w-1/2">
                                    ...
                                    <div class="flex" id="div-featured-incoming">
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="featured_yes-incoming" class="ms-2 leading-7 text-sm text-gray-600">Ya</label>
                                        </div>
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="featured_no-incoming" class="ms-2 leading-7 text-sm text-gray-600">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div x-show="openIncoming" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                <div class="p-2 w-full">
                                    <label for="place-incoming" class="block mb-2 text-sm font-medium text-gray-900">Tempat <span class="text-red-700">*</span></label>
                                ...
                                <div class="p-2 w-1/2">
                                    <label for="div-transportation-incoming" class="block mb-2 text-sm font-medium text-gray-900">Pengangkutan Disediakan <span class="text-red-700">*</span></label>
                                    <div class="flex" id="div-transportation-incoming">
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_yes-incoming" class="ms-2 leading-7 text-sm text-gray-600">Ya</label>
                                        </div>
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_no-incoming" class="ms-2 leading-7 text-sm text-gray-600">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="lg:w-4/5 mx-auto flex flex-wrap" x-data="{ openPast: @entangle('forPastProject') }">
                                ...
                                <div class="p-2 w-1/2">
                                    ...
                                    <div class="flex" id="div-featured-past">
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="featured_yes-past" class="ms-2 leading-7 text-sm text-gray-600">Ya</label>
                                        </div>
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="featured_no-past" class="ms-2 leading-7 text-sm text-gray-600">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div x-show="openPast" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <div class="flex flex-wrap -m-2">
                                <div class="p-2 w-full">
                                    <label for="place-past" class="block mb-2 text-sm font-medium text-gray-900">Tempat <span class="text-red-700">*</span></label>
                                ...
                                <div class="p-2 w-1/2">
                                    <label for="div-transportation-past" class="block mb-2 text-sm font-medium text-gray-900">Pengangkutan Disediakan <span class="text-red-700">*</span></label>
                                    <div class="flex" id="div-transportation-past">
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_yes-past" class="ms-2 leading-7 text-sm text-gray-600">Ya</label>
                                        </div>
                                        <div class="flex items-center mx-2 my-0">
                                            ...
                                            <label for="transportation_no-past" class="ms-2 leading-7 text-sm text-gray-600">Tidak</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-2 w-1/2 mt-10">
