                                ...
                                <div class="p-2 w-full">
                                    <form class="max-w-[16rem] mx-auto grid grid-cols-2 gap-4">
                                        <div class="my-2">
                                            ...
                                            <div class="relative">
                                                <input type="time" id="start-time" wire:model.lazy="time_from" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" min="09:00" max="18:00" value="00:00" />
                                            </div>
                                        </div>
                                        <div>
                                            <label for="end-time" class="block mb-2 text-sm font-medium text-gray-900">Masa akhir:</label>
                                            <div class="relative">
                                                <input type="time" id="end-time" wire:model.lazy="time_to" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" min="09:00" max="18:00" value="00:00" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
