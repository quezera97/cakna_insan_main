            ...
            <div class="h-full flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    ...
                    <div class="flex justify-between my-5 text-center">
                        <button wire:click="openUploadBannerModal({{ $project }})" class="mx-auto text-white bg-sky-500 border-0 py-2 px-8 focus:outline-none hover:bg-sky-600 rounded text-lg">Upload</button>

                        @if (isset($project->banner))
                            <button wire:click="editSelectedImage('{{ $project->id }}')" class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Edit</button>
                            <button wire:click="openConfirmationModal('deleteBanner', {{ $project->id }})" class="mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Delete</button>
                        @endif
                    </div>
                </div>
            </div>
