<div class="lg:w-1/4 md:w-1/2 p-4 w-full">
    ...
    <div class="flex justify-between my-5 text-center">
        ...
        <button wire:click="editSelectedImage('{{ $projectImage->id }}')" class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Edit</button>
        <button wire:click="openConfirmationModal('deleteImages', {{ $projectImage->id }})" class="mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Delete</button>
    </div>
