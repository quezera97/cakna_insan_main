...
<div id="{{ $id }}" class="bg-gray-100 bg-opacity-75 fixed z-50 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-white w-1/5 rounded shadow-lg p-8">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">{{ $confirmationModalTitle }}</h2>
                <button wire:click="closeConfirmationModal" class="text-gray-600 hover:text-gray-800 focus:outline-none">
