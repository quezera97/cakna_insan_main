<div>
    <div class="flex justify-between mb-1 mt-5">
        <span class="text-sm font-medium text-black-700">Sumbangan: {{'RM'.number_format($arrProject[0]['sum_donation'], 2) .' / '. 'RM'.number_format($arrProject[0]['donation_needed'], 2) }}</span>
