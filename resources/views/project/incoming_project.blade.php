                ...
                @foreach ($incomingProjects as $project)
                    <div class="p-4 lg:w-1/2">
                        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="{{ asset($project->projectable?->image_path) }}">
                            <div class="flex-grow sm:pl-8">
                                ...
                                <span class="inline-flex">
                                    ...
                                    <a href="{{ route('project_detail') }}" class="ml-4 inline-flex text-gray-700 bg-gray-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg">Butiran</a>
                                </span>
                            </div>
                        </div>
                    </div>
